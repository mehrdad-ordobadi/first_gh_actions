...
SVC_NAME="actions.runner.mehrdad-ordobadi-first_gh_actions.Mehrdads-MacBook-Pro-2"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (mehrdad-ordobadi-first_gh_actions.Mehrdads-MacBook-Pro-2)"
